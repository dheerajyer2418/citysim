...
// Esri basemaps are keyless (like the satellite layer). CARTO's raster
// basemaps now return an "API key required" placeholder tile. Note Esri uses
// {z}/{y}/{x} order (y before x), unlike CARTO's {z}/{x}/{y}.
const BASEMAPS = {
